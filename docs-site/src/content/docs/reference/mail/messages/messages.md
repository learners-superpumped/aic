---
title: "aic mail messages"
description: "List and read stored mail messages"
sidebar:
  label: "Overview"
  order: 0
---

List and read stored mail messages
...
* [aic mail messages show](/reference/mail/messages/show/)	 - Show a message's metadata; optionally write its raw .eml to a file
