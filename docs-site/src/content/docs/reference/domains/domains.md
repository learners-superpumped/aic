---
title: "aic domains"
description: "Domain names — registration and DNS"
sidebar:
  label: "Overview"
  order: 0
---

Domain names — registration and DNS
...
* [aic domains search](/reference/domains/search/)	 - Search availability and pricing
* [aic domains show](/reference/domains/show/)	 - Show a domain
* [aic domains verify](/reference/domains/verify/)	 - Check NS propagation for a connected domain
